...
function scene:show( event )
    ...
    if myData.numOfSpies == "random" then
    	currentSpies = math.random(0, currentPlayers)
    else
       	currentSpies = tonumber(myData.numOfSpies)
    end
	...
	-- set all players to spies if enough spies are chosen
	if (currentSpies >= currentPlayers) then
		currentSpies = currentPlayers
	...
	randomLoc=math.random(1, numOfLocs)
